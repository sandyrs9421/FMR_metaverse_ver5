...
import Script11 from "../69695443-7b21-4caa-9bf9-4147bab4ab6c/src/item"
import Script12 from "../da30258e-3cc1-48a4-bc55-508e923ae977/src/item"
import Script13 from "../bcdcfbe4-bd95-4100-9174-b38785b45e2c/src/item"
...
import Script16 from "../d5ee9a47-8484-4824-a609-996298830b51/src/item"
import Script17 from "../28352c3a-cc20-4ab4-b4b8-a4562a6b0d4d/src/item"
import Script18 from "../c5cbd030-54d0-4f28-9158-d27401c691b1/src/item"
import Script19 from "../e7a6c753-ea84-4c8e-bb94-4523407a5d55/src/item"
...
const transform102 = new Transform({
  position: new Vector3(5.5, 1, 7.5),
  rotation: new Quaternion(2.748709793508482e-16, 0.7071067690849304, -8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(1.0000004768371582, 1, 1.0000004768371582)
})
microwave.addComponentOrReplace(transform102)

const speakers = new Entity('speakers')
engine.addEntity(speakers)
speakers.setParent(_scene)
const transform103 = new Transform({
  position: new Vector3(5.5, 1, 6),
  rotation: new Quaternion(-4.919850054899122e-16, 0.7071068286895752, -8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(1.0000039339065552, 1, 1.0000039339065552)
})
speakers.addComponentOrReplace(transform103)
...
table.addComponentOrReplace(transform104)
const gltfShape16 = new GLTFShape("619c08da-51a4-49db-9ad5-49e5e88b344b/Table 2.glb")
gltfShape16.withCollisions = true
gltfShape16.isPointerBlocker = true
gltfShape16.visible = true
table.addComponentOrReplace(gltfShape16)
...
grassTile33.addComponentOrReplace(transform105)
...
grassTile34.addComponentOrReplace(transform106)
...
neonRectangleSign.addComponentOrReplace(transform107)
const gltfShape17 = new GLTFShape("5e74295e-315c-4581-be84-61a8069f1f4d/Neon_Rectangle_Sign.glb")
gltfShape17.withCollisions = true
gltfShape17.isPointerBlocker = true
gltfShape17.visible = true
neonRectangleSign.addComponentOrReplace(gltfShape17)
...
galleryInfoGlass.addComponentOrReplace(transform108)
...
facebookButtonLink.addComponentOrReplace(transform109)
...
twitterButtonLink.addComponentOrReplace(transform110)
...
instagramButtonLink.addComponentOrReplace(transform111)
...
streetClock.addComponentOrReplace(transform112)
const gltfShape18 = new GLTFShape("3e718ab8-14e9-4352-a972-620da3ae778c/StreetClock_01/StreetClock_01.glb")
gltfShape18.withCollisions = true
gltfShape18.isPointerBlocker = true
gltfShape18.visible = true
streetClock.addComponentOrReplace(gltfShape18)
...
signpostTree.addComponentOrReplace(transform113)
...
plainText4.addComponentOrReplace(transform116)
...
plainText5.addComponentOrReplace(transform117)
...
plainText6.addComponentOrReplace(transform118)
...
informationTerminal.addComponentOrReplace(transform119)
const gltfShape19 = new GLTFShape("5e4a922e-50f1-40aa-a1a3-bee660371499/Terminal_01/Terminal_01.glb")
...
streetMailbox.addComponentOrReplace(transform120)
const gltfShape20 = new GLTFShape("38832f4a-2a1b-4139-8d73-3146f1261e95/MailPost_01/MailPost_01.glb")
gltfShape20.withCollisions = true
gltfShape20.isPointerBlocker = true
gltfShape20.visible = true
streetMailbox.addComponentOrReplace(gltfShape20)
...
urbanTrashCan.addComponentOrReplace(transform121)
const gltfShape21 = new GLTFShape("c5daf807-1dde-41e8-a1db-c30f58917457/TrashCan_01/TrashCan_01.glb")
gltfShape21.withCollisions = true
gltfShape21.isPointerBlocker = true
gltfShape21.visible = true
urbanTrashCan.addComponentOrReplace(gltfShape21)
...
externalLink3.addComponentOrReplace(transform122)
...
ambientSound.addComponentOrReplace(transform123)
...
wallPlainGlass19.addComponentOrReplace(transform124)
...
wallPlainGlass20.addComponentOrReplace(transform125)
...
wallPlainGlass21.addComponentOrReplace(transform126)
...
wallPlainGlass22.addComponentOrReplace(transform127)
...
grassTile35.addComponentOrReplace(transform128)
...
galleryInfoBlack2.addComponentOrReplace(transform129)
...
grassTile36.addComponentOrReplace(transform130)
...
grassTile37.addComponentOrReplace(transform131)
...
grassTile38.addComponentOrReplace(transform132)
...
signpostGolden4.addComponentOrReplace(transform133)
...
plainText2.addComponentOrReplace(transform134)
...
externalLink4.addComponentOrReplace(transform135)
...
externalLink5.addComponentOrReplace(transform136)
...
externalLink6.addComponentOrReplace(transform137)
...
tableWithChairs2.addComponentOrReplace(transform138)
...
plainText7.addComponentOrReplace(transform139)
...
blockFloorLight3.addComponentOrReplace(transform140)
...
blockFloorLight4.addComponentOrReplace(transform141)
...
couchTwoSeater.addComponentOrReplace(transform142)
const gltfShape22 = new GLTFShape("c28761f2-759f-4b9a-b497-9dfcabf3aa3f/TwoSeater_Couch.glb")
gltfShape22.withCollisions = true
gltfShape22.isPointerBlocker = true
gltfShape22.visible = true
couchTwoSeater.addComponentOrReplace(gltfShape22)
...
messageBubble.addComponentOrReplace(transform143)
...
script11.spawn(microwave, {"clickable":true}, createChannel(channelId, microwave, channelBus))
script12.spawn(speakers, {"clickable":true}, createChannel(channelId, speakers, channelBus))
script13.spawn(galleryInfoGlass, {"text":"WELCOME FBT INNOVATION \n\nPLEASE CHECK BELOW LINKS","fontSize":5,"font":"SF_Heavy","color":"#000000"}, createChannel(channelId, galleryInfoGlass, channelBus))
script14.spawn(facebookButtonLink, {"url":"fidelityinvestments","bnw":false}, createChannel(channelId, facebookButtonLink, channelBus))
script15.spawn(twitterButtonLink, {"url":"Fidelity","bnw":false}, createChannel(channelId, twitterButtonLink, channelBus))
script16.spawn(instagramButtonLink, {"url":"fidelity","bnw":false}, createChannel(channelId, instagramButtonLink, channelBus))
script17.spawn(signpostTree, {"text":"FMR WORLD ","fontSize":22}, createChannel(channelId, signpostTree, channelBus))
...
script18.spawn(ambientSound, {"sound":"Birds","active":true,"loop":true}, createChannel(channelId, ambientSound, channelBus))
...
script19.spawn(messageBubble, {"text":"LET'S TALK CRYPTO!!!!","fontSize":14.5}, createChannel(channelId, messageBubble, channelBus))